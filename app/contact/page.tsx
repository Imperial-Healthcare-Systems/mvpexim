  ...
  return (
    <>
      <PageHeader
        ...
        imageAlt="The Bengaluru skyline at dusk, the city we trade from"
        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
          <Reveal>
            ...
            <Card className="mt-8" padded={false}>
              ...
              {/* The Bengaluru photograph now runs full-bleed in the masthead,
                  so this stays a plain locator strip rather than repeating it
                  on the same page. Swap for an <iframe> when a real map is
                  wanted — the layout does not change. */}
              <div className="flex flex-wrap items-center justify-between gap-3 border-t border-line bg-surface-dark px-6 py-5">
                <p className="text-caption font-semibold uppercase tracking-wide text-gold">
                  {siteConfig.address.city}, {siteConfig.address.state}
                </p>
                <p className="tabular text-caption text-on-dark-muted">
