...
export const products: Product[] = [
  {
    ...
    imageAlt:
      'Biscuit-colour semi-husked coconuts stacked in bulk after grading',
    imageLabel: 'Semi-husked coconut, graded',
    status: 'available',
    detailPage: true,
    intro:
  ...
  },
  {
    ...
    imageAlt: 'Cones of spun cotton yarn racked in a textile mill',
    imageLabel: 'Spun cotton yarn',
    status: 'coming-soon',
    detailPage: false,
    specs: [],
    markets: [],
  },
  {
    ...
    imageAlt: 'A craftsman marking out a finished tan leather hide',
    imageLabel: 'Finished leather hide',
    status: 'coming-soon',
    detailPage: false,
    specs: [],
    markets: [],
  },
  {
    ...
    imageAlt: 'Industrial polymer granules poured out for inspection',
    imageLabel: 'Polymer granules',
    status: 'coming-soon',
    detailPage: false,
    specs: [],
    markets: [],
